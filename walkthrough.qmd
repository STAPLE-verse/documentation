...
When creating a task, you will define: - The task name - The task description or a how-to complete the task - The element a task should be assigned to (or none) - The person or team associated with the task - If the task needs an "output" (something that needs metadata) - If so, what type of metadata should the task include?
